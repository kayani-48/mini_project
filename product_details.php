...
<section class="py-5">
  <div class="container">
    <div class="row gx-5">
      ...
      <img class="rounded-4 img-fluid w-100 h-100" src="images/product_images/<?php echo $row["product_image"] ?>" />
      ...
      <main class="col-lg-6">
        <div class="ps-lg-3">
          ...
          <div class="mb-3">
            <span class="h5">PKR : <?php echo $row["product_price"] ?></span>
          ...
          <div class="row">
            ...
            <dd class="col-9"><?php echo $row["product_category"] ?></dd>
          ...
          <a href="process.php?add_to_cart&product_id=<?php echo $row['product_id'] ?>" class="btn btn-primary shadow-0"> <i class="me-1 fa fa-shopping-basket"></i> Add to cart </a>
